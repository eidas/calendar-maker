...
export default function CalendarCell({ date, isCurrentMonth, isToday, holiday, events, theme, onClick, onEventClick }) {
  ...
  return (
    <div
      className="border-r border-b min-h-[72px] p-1 cursor-pointer hover:brightness-95 flex flex-col"
